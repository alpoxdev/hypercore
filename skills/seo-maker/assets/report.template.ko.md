...
**주요 발견사항**: [가장 중요한 발견사항을 1-3문장으로 요약]

## 측정 및 신뢰도

| 방법 | 상태 | 증거 등급 | 신뢰도 영향 | 메모 |
|------|------|-----------|-------------|------|
...
> 주의: 라이브 URL, Search Console, field Core Web Vitals, AI 엔진 접근이 불가능하면 확실성을 암시하지 말고 영향을 받는 점수의 신뢰도를 낮게 표시한다.
...
| 플랫폼/봇 | 목적 | 상태 | 증거 등급 | 신뢰도 | 출처 계층 | 권장사항 |
|-----------|------|------|-----------|--------|-----------|----------|
| Googlebot | 검색 크롤링/색인 | [status] | [official/observed-file] | [high/medium/low] | [official-doc/observed-file] | [action] |
| OAI-SearchBot | ChatGPT Search 포함 | [status] | [official/observed-file] | [high/medium/low] | [official-doc/observed-file] | [action] |
| GPTBot | OpenAI 모델 학습 | [status] | [official/observed-file] | [high/medium/low] | [official-doc/observed-file] | [action] |
| llms.txt | 선택적 LLM 대상 콘텐츠 맵 | [present/missing/not-applicable] | [heuristic/lab] | [medium/low] | [research-backed-heuristic/observed-file] | [action] |
