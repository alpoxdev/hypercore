...
- Produce an improved skill plus durable experiment artifacts under `.hypercore/autoresearch-skill/[skill-name]/`: `results.tsv`, `results.json`, `changelog.md`, `dashboard.html`, and `SKILL.md.baseline`.
...
- create the workspace under `.hypercore/autoresearch-skill/[skill-name]/`
...
| 2 | Initialize the experiment workspace and artifacts | `.hypercore/autoresearch-skill/[skill-name]/` |
...
- `.hypercore/autoresearch-skill/[skill-name]/results.js` or an equivalent file-backed bridge when direct local browser opening requires it
