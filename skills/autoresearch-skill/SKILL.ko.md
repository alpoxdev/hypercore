...
6. 선택 예산 상한
7. Run contract 가정: scope, authority, evidence, tools, output, verification, stop condition
...
```json
{
  "validator_prompt": "Review the optimized skill against the mission and binary eval set.",
  "architect_review": { "verdict": "approved" },
  "output_artifact_path": ".hypercore/autoresearch-skill/my-skill/results.json"
}
```
