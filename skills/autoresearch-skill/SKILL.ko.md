...
description: "기존 Codex 스킬을 baseline-first 실험, binary eval, 선택적 Guard, 단일 변이 반복으로 최적화한다. Use when: 스킬 autoresearch, 반복 실험 기반 개선, self-optimize skill, benchmark skill changes, 또는 skill experiment artifact resume."
