...
| Evidence | 로컬 대상 파일, `instructions/skill/`, repo instruction 문서, provider-sensitive할 때만 공식 references, eval 또는 harness 출력을 근거로 삼습니다. |
...
| 5 | trigger, anatomy, resource, contract, safety, validation 관점에서 재독 | 검토 메모 |
