...
> 이 파일에는 외부 출처를 사용하지 않았습니다. 공식 Hono 동작은 `references/official/hono-docs.ko.md`에, Drizzle 동작은 `references/official/drizzle-docs.ko.md`에 위임합니다(둘 다 last verified 2026-08-04). 저장소 로컬 링크 확인 2026-09-21.
