...
> 위에 인용한 URL은 2026-09-21에 모두 HTTP 200으로 응답했습니다(링크 확인 2026-09-21). 발견 자체는 `.omo/ulw-research/20260916-163039/sources-ledger.md`에 기록된 2026-09-16 리서치에서 나왔습니다.

행별 링크는 네이버 자체 게시물과 도움말(blog.naver.com/naver_search, blog.naver.com/blogpeople, searchadvisor.naver.com, help.naver.com)입니다. 외부 출처가 없는 세 묶음은 본문에 그렇게 표시했습니다. §4 수치 범위(이 저장소가 직접 측정한 실제 상위 글), §6 현장 실험(DOI는 세션 레저에 있고 여기서 다시 검증하지 않음), §10 미해결 항목. 같은 공식 링크의 게시 날짜는 `naver-algorithm-timeline.ko.md`에 있습니다.
