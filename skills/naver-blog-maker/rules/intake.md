...
- Restate the five answers in one line (`블로그 / 목표 / 업체·관계 / 자료 / 양식`) at the top of the reply, then run `post-workflow.md` from §0 without further questions. The mode (정보/전환) is derived there from the relationship and the goal, not asked here.
