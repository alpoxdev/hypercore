...
description: Combine 10 genius-thinking formulas with validated innovation frameworks (TRIZ, SCAMPER, JTBD, HMW) to generate 10+ high-quality ideas with evidence-based prioritization.
---
...
Source: [Christensen Institute - JTBD](https://www.christenseninstitute.org/theory/jobs-to-be-done/)
...
Source: [MindTools - Six Thinking Hats](https://www.mindtools.com/ajlpp1e/six-thinking-hats/)
...
|------|------|------|
| **S**ubstitute | Replace? | Netflix: DVD -> streaming |
| **C**ombine | Combine? | Smartphone = phone + camera + computer |
| **A**dapt | Borrow? | Roll-on deodorant <- ballpoint concept |
| **M**odify | Magnify/minify? | iPad Mini / Pro segmentation |
| **P**ut to other use | New use? | McDonald's as real-estate business |
| **E**liminate | Remove? | Remove waiter-heavy process with self-service |
| **R**everse | Reverse? | Pay-first -> consume-later reversal patterns |

Source: [IxDF - SCAMPER](https://www.interaction-design.org/literature/article/learn-how-to-use-the-best-ideation-methods-scamper)
...
| Action | Question |
|------|------|
| **E**liminate | What industry assumptions should be removed? |
| **R**educe | What should be reduced below standard? |
| **R**aise | What should be raised above standard? |
| **C**reate | What should be newly created? |

Source: [Stanford d.school](https://dschool.stanford.edu/), [Blue Ocean ERRC](https://www.blueoceanstrategy.com/tools/errc-grid/)
...
Source: [TRIZ Wikipedia](https://en.wikipedia.org/wiki/TRIZ)
...
Source: [ScienceDirect 2024](https://www.sciencedirect.com/science/article/pii/S1871187124000373)
...
Source: [Ness Labs - Zwicky Box](https://nesslabs.com/zwicky-box)
...
Source: [Nature 2025](https://www.nature.com/articles/s42003-025-07470-9)
...
ToT reference: [arXiv](https://arxiv.org/abs/2305.10601)
...
- SCAMPER: [IxDF](https://www.interaction-design.org/literature/article/learn-how-to-use-the-best-ideation-methods-scamper)
- JTBD: [Christensen Institute](https://www.christenseninstitute.org/theory/jobs-to-be-done/)
- ERRC: [Blue Ocean](https://www.blueoceanstrategy.com/tools/errc-grid/)

**Cognitive science**:
- DMN-ECN switching: [Nature 2025](https://www.nature.com/articles/s42003-025-07470-9)
- Incubation effect: [ScienceDirect 2024](https://www.sciencedirect.com/science/article/pii/S1871187124000373)

**Execution methods**:
- HMW: [Stanford d.school](https://dschool.stanford.edu/)
- Six Hats: [MindTools](https://www.mindtools.com/ajlpp1e/six-thinking-hats/)
- Zwicky Box: [Ness Labs](https://nesslabs.com/zwicky-box)
