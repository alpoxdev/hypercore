---
description: tsc 타입 오류 검사 및 하나씩 수정
...
| **Type Safety** | 명시적 타입, unknown 사용 | `any`, `@ts-ignore` |
...
```typescript
// 오류: Property 'foo' does not exist on type 'Bar'
interface Bar {
  name: string
}
